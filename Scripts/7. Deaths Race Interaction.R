...
estimates = c("Segregation, Death Rate", "Effect Modification (95% CI)", values)
tabletext<-cbind(variables, estimates)

png(file="~/Desktop/Covid disparities/health disparity/Output/Death_Race_Interaction.png",width=1100,height=400)
forestplot(tabletext,
           ...
           col=fpColors(box=c("tomato1", "tomato4"),
                        line=c("tomato1", "tomato4")),
...
round(cbind(mean, lower, upper), digits = 2)
