...
confint = read.csv("~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Multivariable.csv")
...
estimates = c("Multivariable", "Total Death Rate","RR (95% CI)", 
...
png(file="~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Multivariable.png",width=1300,height=1200)
forestplot(tabletext, 
           ...
           vertices=TRUE, 
           xlog=TRUE,
           xticks=c(0.85, 1.0, 1.25, 1.50),
           grid = structure(c(0.85, 1.25, 1.50),
                            gp = gpar(lty=2, col="#FFCCCC")),
           col=fpColors(box="red",line="red", summary="darkred"),
           xlab="Total Death Rate Relative Risk",
