...
confint = read.csv("~/Desktop/Covid disparities/health disparity/Output/Case Rate Total Multivariable.csv")
...
estimates = c("Multivariable", "Total Case Rate","RR (95% CI)", 
...
png(file="~/Desktop/Covid disparities/health disparity/Output/Case Rate Total Multivariable.png",width=1300,height=1200)
forestplot(tabletext, 
           ...
           vertices=TRUE, 
           xlog=TRUE,
           xticks=c(0.85, 1.0, 1.15, 1.25),
           grid = structure(c(0.85, 1.15, 1.25),
                            gp = gpar(lty=2, col="#CCCCFF")),
           col=fpColors(box="royalblue",line="royalblue", summary="darkred"),
           xlab="Total Case Rate Relative Risk",
