data = read.csv("~/Desktop/Covid disparities/health disparity/Output/CFR Weekly Multivariable.csv")
...
write.csv(table, 
          file = "~/Desktop/Covid disparities/health disparity/Output/Table S2.csv")
