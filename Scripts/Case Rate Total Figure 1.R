...
confint = read.csv("~/Desktop/Covid disparities/health disparity/Output/Case Rate Total Univariable.csv")
...
estimates = c("Univariable", "Total Case Rate","RR (95% CI)", 
...
png(file="~/Desktop/Covid disparities/health disparity/Output/Case Rate Total Univariable.png",width=1300,height=1200)
forestplot(tabletext, 
           ...
           col=fpColors(box="royalblue4",line="royalblue4", summary="darkred"),
