...
write.csv(univariable, 
          file="~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Univariable.csv",
          row.names=F)

write.csv(multivariable, 
          file="~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Multivariable.csv",
          row.names=F)
