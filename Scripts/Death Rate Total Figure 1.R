...
confint = read.csv("~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Univariable.csv")
...
estimates = c("Univariable", "Total Death Rate","RR (95% CI)", 
...
png(file="~/Desktop/Covid disparities/health disparity/Output/Death Rate Total Univariable.png",width=1300,height=1200)
forestplot(tabletext, 
           ...
           col=fpColors(box="red3",line="red3", summary="darkred"),
