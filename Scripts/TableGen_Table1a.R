data = read.csv("~/Desktop/Covid disparities/health disparity/Output/Case Rate Weekly Multivariable.csv")
...
write.csv(table, 
          file = "~/Desktop/Covid disparities/health disparity/Output/Table 1a.csv")
