...
confint = read.csv("~/Desktop/Covid disparities/health disparity/Output/CFR Total Multivariable.csv")
...
estimates = c("Multivariable", "Case Fatality Rate","RR (95% CI)", 
...
png(file="~/Desktop/Covid disparities/health disparity/Output/CFR Total Multivariable.png",width=1300,height=1200)
forestplot(tabletext, 
           ...
           col=fpColors(box="orchid2",line="orchid2", summary="orchid2"),
