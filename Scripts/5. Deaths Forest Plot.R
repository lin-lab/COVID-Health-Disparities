...
png(file="~/Desktop/Covid disparities/health disparity/Output/Death_Forest_Plot.png",width=1200,height=1200)
forestplot(tabletext, 
           ...
           vertices=TRUE, 
           xlog=TRUE,
           xticks=c(0.80, 1.0, 1.20, 1.40),
           grid = structure(c(0.80, 1.20, 1.40),
